...
public class Adminunverifiedprovider_test extends TestBase{
	 ...
	 ScreenRecording screenRecord;
	  ...
	  public void TC_09_AdminVerify_UnverifiedDoctor() throws Exception {
	    AdminUnverifiedDoctors a2 = new AdminUnverifiedDoctors();
	  ...
	  @Test(
	      dependsOnMethods = {"TC_09_AdminVerify_UnverifiedDoctor"},
	      description = "Admin Logout from EzScheduler Website")

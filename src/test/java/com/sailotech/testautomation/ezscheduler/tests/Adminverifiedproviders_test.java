...
public class Adminverifiedproviders_test extends TestBase {
  ...
  @TestCaseId("TC_11")
  @Severity(SeverityLevel.NORMAL)
  @Description("Admin checks verified doctors Details")
  @Test(
      dependsOnMethods = {"TC_08_Navigate_to_AdminLogin"},
      description = "Admin checking Verified Doctor details (Negativescenarios)")
  public void TC_11_Admin_VerifyDoctor_negativescenarios() throws Exception {
    AdminVerifiedDoctors a4 = new AdminVerifiedDoctors();
    a4.AdminCheckverifiedDoctor(driver);
  }
  ...
  @Test(
      dependsOnMethods = {"TC_11_Admin_VerifyDoctor_negativescenarios"},
      description = "Admin Logout from EzScheduler Website")
